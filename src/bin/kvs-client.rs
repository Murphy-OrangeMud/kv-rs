...
use kvs::{Result, Command as kCommand, Record};
...
fn main() -> Result<()> {
    ...
    match matches.subcommand() {
        Some(("set", _matches)) => {
            ...
            let record = Record {
                cmd: kCommand::Set,
                key: _matches.get_one::<String>("KEY").expect("required").to_string(),
                value: _matches.get_one::<String>("VALUE").expect("required").to_string(),
            };
